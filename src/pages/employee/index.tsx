...
const UserPage = () => {
  ...
  const onEdit = (id: string) => {
    return router.push(`/employee/${id}`);
  };
  ...
  const usersColumns: any = [
    ...
    // },
    {
      ...
      key: "first_name",
      sorter: true,
      sortOrder: checkResetSortOrder("first_name"),
      render: (value: string) => (
    ...
    },
    {
      ...
      key: "last_name",
      sorter: true,
      sortOrder: checkResetSortOrder("last_name"),
      render: (value: string) => (
        <Typography.Text size="20">{value || "-"}</Typography.Text>
      ),
    },
    ...
    {
      title: "Position",
      dataIndex: ["position_info", "name"],
      key: "name",
      sorter: true,
      sortOrder: checkResetSortOrder("position_info.name"),
      render: (value: string) => (
        <Typography.Text size="20">{value || "-"}</Typography.Text>
      ),
    },
    {
      title: "Role",
      dataIndex: ["role_info", "name"],
      key: "name",
      width: 100,
      sorter: true,
      sortOrder: checkResetSortOrder("role_info.name"),
  ...
  const onAdd = () => {
    return router.push(`/employee/create`);
  };
